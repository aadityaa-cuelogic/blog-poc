...
urlpatterns = [
    ...
    url(r'^password_reset/$', auth_views.password_reset, {'template_name': 'forgot_password.html'}, name="forgot_password"),
    url(r'^password_reset/done$', auth_views.password_reset_done,{'template_name': 'forgot_password_done.html'}, name='password_reset_done'),
